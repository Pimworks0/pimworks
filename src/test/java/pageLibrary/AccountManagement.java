...
public class AccountManagement extends ReusableLibrary {
    ...
    public AccountManagement(WebDriver driver) throws IOException {
        super(driver);
        this.driver=driver;
        implicitWait(5);
    ...
    public  void clickSave(){
        try {
            ...
            ExtentFactory.getInstance().getExtent().pass("click on the save button successful");
        }
        catch (Exception e)
        {
            ExtentFactory.getInstance().getExtent().fail("not able to click on save");
    ...
    public  void seletAllModule(){
        try {
            ...
            ExtentFactory.getInstance().getExtent().pass("user able to select all modules");
        }catch (Exception e){
            ExtentFactory.getInstance().getExtent().fail("user not able to select all modules");
        }
    ...
    public  void clickReadonly(){
        try {
            ...
            ExtentFactory.getInstance().getExtent().pass("user able to select readonly ");
        }
        catch (Exception e){
            ExtentFactory.getInstance().getExtent().fail("user not able to select readonly");
        }
