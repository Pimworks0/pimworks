...
public class Attribute_Rule_Frmla_5 {

    // ----FORMULA ceiling mark-up2(Other) = 100 * ( 100 / ( 100 - Ceiling Markup Fee ) - 1 )-----------
    ...
    public String readdata(int row, int cell) throws Exception {
        return readExcel("Attribute_Rule_Frmla_5", row, cell, Datapath);
    }
