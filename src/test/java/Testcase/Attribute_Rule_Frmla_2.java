...
public class Attribute_Rule_Frmla_2 {

    // ----FORMULA Cubic feet Volume(Price) = ( ( Ship Length1(Size) * Ship Width1(Size) * Ship Height1(Size) ) / 1728 )-----------
    ...
    public String readdata(int row, int cell) throws Exception {
        return readExcel("Attribute_Rule_Frmla_2", row, cell, Datapath);
    }
    ...
    @Test(priority = 3)
    public void createAttributeGroup_2() throws Exception {
        AccountManagement user = new AccountManagement(driver);
        // --------------move to the side menu ---------------
        user.moveTosidemenu();
        System.out.println(getLocator().getProperty("Settings"));
        ...
        driver.findElement(By.xpath(getLocator().getProperty("CreateGroup"))).click();
        ExtentFactory.getInstance().getExtent().pass("user clicked on Create Group");
        driver.findElement(By.xpath(getLocator().getProperty("AttributeGroupName"))).sendKeys(readdata(24, 1));
        driver.findElement(By.xpath(getLocator().getProperty("Attributeorder"))).sendKeys(readdata(25, 1));
        driver.findElement(By.xpath(getLocator().getProperty("SaveAtrribute"))).click();
        ExtentFactory.getInstance().getExtent().pass(" Create Attribute Group displayed on the screen ");
        ExtentFactory.getInstance().getExtent().pass(" User Enter Attribute group Name and Display order than click save button");
        Thread.sleep(7000);
    ...
    @Test(priority = 4)
    public void createAttribute_2() throws Exception {
        ...
        driver.findElement(By.xpath(getLocator().getProperty("attibutesNamae"))).sendKeys(readdata(6, 1));
        Thread.sleep(2000);
        ExtentFactory.getInstance().getExtent().pass(" display Add New Attribute popup and user entered the Attribute name");
        Select dropdown = new Select(driver.findElement(By.id(getLocator().getProperty("atrributsDropdown"))));
        dropdown.selectByVisibleText(readdata(24, 1));
        ExtentFactory.getInstance().getExtent().pass(" user select respected Attribute group from drop down");
        driver.findElement(By.xpath(getLocator().getProperty("attrubuteSubmit"))).click();
        ExtentFactory.getInstance().getExtent().pass(" user click on Save Button for Attribute page");
        ExtentFactory.getInstance().getExtent().pass(readdata(6, 1) + "item created");
    ...
    public void addAtributestoTaxonomy() throws Exception {
        ...
        Thread.sleep(2000);
        driver.findElement(By.id(getLocator().getProperty("teonomybox"))).sendKeys(readdata(9, 1));
        Thread.sleep(2000);
    ...
    public void createAttributeRule() throws Exception {
        ...
        driver.findElement(By.xpath(getLocator().getProperty("Rule_Name_Input"))).sendKeys(readdata(10, 1));

        AddAttributeToRule("Add_Attribute_btn", "Attribute_select",
                "Frmla_Attribute_search_1", 11);
        AddOperatorToRule("Add_Attribute_btn", "Operator_select",
                "Frmla_2_Operator_search_1", 12);
        AddOtherOptionToRule("Add_Attribute_btn","Other_Option",
                "Frmla_2_Other_Options_search_1",13);
        AddOtherOptionToRule("Add_Attribute_btn","Other_Option",
                "Frmla_2_Other_Options_search_2",14);
        AddAttributeToRule("Add_Attribute_btn", "Attribute_select",
                "Frmla_Attribute_search_2", 15);
        AddOperatorToRule("Add_Attribute_btn", "Operator_select",
                "Frmla_2_Operator_search_2", 16);
        AddAttributeToRule("Add_Attribute_btn", "Attribute_select",
                "Frmla_Attribute_search_3", 17);
        AddOperatorToRule("Add_Attribute_btn", "Operator_select",
                "Frmla_2_Operator_search_3", 18);
        AddAttributeToRule("Add_Attribute_btn", "Attribute_select",
                "Frmla_Attribute_search_4", 19);
        AddOtherOptionToRule("Add_Attribute_btn","Other_Option",
                "Frmla_2_Other_Options_search_3",20);
        AddOperatorToRule("Add_Attribute_btn", "Operator_select",
                "Frmla_2_Operator_search_4", 21);
        AddValueToRule("Add_Attribute_btn","Value_select",
                "Frmla_2_Value_input_1",22);
        AddOtherOptionToRule("Add_Attribute_btn","Other_Option",
                "Frmla_2_Other_Options_search_4",23);
    ...
    public void RuleAddStep2_3() throws Exception {
        ...
        double j = Double.parseDouble(readdata(26, 1));
        ...
        driver.findElement(By.xpath(getLocator().getProperty("Search_Taxonomy"))).sendKeys(readdata(9, 1));
        Thread.sleep(5000);
        driver.findElement(By.xpath(getLocator().getProperty("Select_all_taxonomy"))).click();
    ...
    public void addProduct() throws Exception {
        ...
        driver.findElement(By.xpath(getLocator().getProperty("SKUvalue"))).sendKeys(readdata(27,1));
        Thread.sleep(2000);
        driver.findElement(By.xpath(getLocator().getProperty("ProductName"))).sendKeys(readdata(28,1));
        Thread.sleep(2000);
        ...
        driver.findElement(By.xpath(getLocator().getProperty("boxtosearch"))).sendKeys(readdata(9,1));
