...
public class Min_Max_Check extends TestBase {
    ...
    public String readdata(int row, int cell) throws Exception {
        return  readExcel("Attribute_Min_Max_Check",row,cell,Datapath);
    }
...
//    }
    ...
    @Test(priority = 4)
    public void enterMinMaxValue() throws Exception {
        driver.findElement(By.xpath(getLocator().getProperty("MinValue_1"))).click();
        driver.findElement(By.id(getLocator().getProperty("MinValueEnter"))).clear();
        driver.findElement(By.xpath(getLocator().getProperty("MinValue_1"))).click();
        Thread.sleep(3000);
        driver.findElement(By.id(getLocator().getProperty("MinValueEnter"))).sendKeys(readdata(13,1));
        Thread.sleep(3000);
        driver.findElement(By.xpath(getLocator().getProperty("MaxValue_1"))).click();
        driver.findElement(By.xpath(getLocator().getProperty("MaxValueEnter"))).clear();
        driver.findElement(By.xpath(getLocator().getProperty("MaxValue_1"))).click();
        driver.findElement(By.xpath(getLocator().getProperty("MaxValueEnter"))).sendKeys(readdata(14,1));
        Thread.sleep(3000);
        driver.findElement(By.xpath(getLocator().getProperty("saveAttributes"))).click();
        Thread.sleep(7000);

        driver.findElement(By.xpath(getLocator().getProperty("MinValue_2"))).click();
        driver.findElement(By.id(getLocator().getProperty("MinValueEnter"))).clear();
        driver.findElement(By.xpath(getLocator().getProperty("MinValue_2"))).click();
        Thread.sleep(3000);
        driver.findElement(By.id(getLocator().getProperty("MinValueEnter"))).sendKeys(readdata(13,1));
        Thread.sleep(3000);
        driver.findElement(By.xpath(getLocator().getProperty("MaxValue_2"))).click();
        driver.findElement(By.xpath(getLocator().getProperty("MaxValueEnter"))).clear();
        driver.findElement(By.xpath(getLocator().getProperty("MaxValue_2"))).click();
        driver.findElement(By.xpath(getLocator().getProperty("MaxValueEnter"))).sendKeys(readdata(15,1));
        Thread.sleep(3000);
        driver.findElement(By.xpath(getLocator().getProperty("saveAttributes"))).click();
        Thread.sleep(7000);
        ExtentFactory.getInstance().getExtent().pass("Min and Max Values are saved successfully");
    }

    @Test(priority = 5)
    public void addPossibleValues() throws Exception {
        driver.findElement(By.xpath(getLocator().getProperty("PossibleValueClick"))).click();
       ...
       // driver.findElement(By.xpath(getLocator().getProperty("AddValueDialogCloseBtn"))).click();
        ...
        driver.findElement(By.xpath(getLocator().getProperty("AddValuebtn"))).click();
        driver.findElement(By.xpath(getLocator().getProperty("AddNewValue"))).clear();
        driver.findElement(By.xpath(getLocator().getProperty("AddNewValue"))).sendKeys(readdata(12,1));
        driver.findElement(By.xpath(getLocator().getProperty("AddValuebtn"))).click();
        driver.navigate().refresh();
        driver.switchTo().alert().accept();
        Thread.sleep(7000);
    ...
    public void addAtributestoTaxonomy() throws Exception {
        ...
        Thread.sleep(2000);
        driver.findElement(By.id(getLocator().getProperty("teonomybox"))).sendKeys(readdata(16,1));
        Thread.sleep(2000);
        ...
        driver.findElement(By.xpath(getLocator().getProperty("SKUvalue"))).sendKeys(readdata(17,1));
        Thread.sleep(2000);
        driver.findElement(By.xpath(getLocator().getProperty("ProductName"))).sendKeys(readdata(18,1));
        Thread.sleep(2000);
        ...
        driver.findElement(By.xpath(getLocator().getProperty("boxtosearch"))).sendKeys(readdata(16,1));
    ...
    @Test(priority = 7)
    public void validationMinMax() throws Exception {
        driver.findElement(By.xpath(getLocator().getProperty("SelectorClick"))).click();
        Thread.sleep(4000);
        driver.findElement(By.xpath(getLocator().getProperty("Android_checkbox"))).click();
        driver.findElement(By.xpath(getLocator().getProperty("BlackberryCheckbox"))).click();
        driver.findElement(By.xpath(getLocator().getProperty("BlueberryCheckbox"))).click();
        driver.findElement(By.xpath(getLocator().getProperty("ErrorIconClick"))).click();
        String error1 = driver.findElement(By.xpath(getLocator().getProperty("ErrorMessage"))).getText();
        System.out.println("Error from scren:"+error1);
        System.out.println("Error from Excel:"+readdata(19,1));
         Assert.assertEquals(error1,readdata(19,1),"Max error check message is wrong.");
        ExtentFactory.getInstance().getExtent().pass("Max Validation is successful");
        ...
        Thread.sleep(7000);
        driver.findElement(By.xpath(getLocator().getProperty("SelectorClick_2"))).click();
        driver.findElement(By.xpath(getLocator().getProperty("SelectApple"))).click();
        driver.findElement(By.xpath(getLocator().getProperty("Savebutton"))).click();
        driver.findElement(By.xpath(getLocator().getProperty("OkButton"))).click();
    }
