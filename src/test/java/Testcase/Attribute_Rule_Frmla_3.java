...
public class Attribute_Rule_Frmla_3 {
    ...
    public String readdata(int row, int cell) throws Exception {
        return readExcel("Attribute_Rule_Frmla_3", row, cell, Datapath);
    }
    ...
    public void addAtributestoTaxonomy() throws Exception {
        ...
        Thread.sleep(2000);
        driver.findElement(By.id(getLocator().getProperty("teonomybox"))).sendKeys(readdata(8, 1));
        Thread.sleep(2000);
...
//        Thread.sleep(10000);
    ...
    public void createAttributeRule() throws Exception {
        ...
        driver.findElement(By.xpath(getLocator().getProperty("Rule_Name_Input"))).sendKeys(readdata(9, 1));

        AddAttributeToRule("Add_Attribute_btn", "Attribute_select",
                "Frmla_3_Attribute_search_1", 10);
        AddOperatorToRule("Add_Attribute_btn", "Operator_select",
                "Frmla_3_Operator_search_1", 11);
        AddAttributeToRule("Add_Attribute_btn", "Attribute_select",
                "Frmla_3_Attribute_search_2", 12);
        AddOperatorToRule("Add_Attribute_btn", "Operator_select",
                "Frmla_3_Operator_search_2", 13);
        AddOtherOptionToRule("Add_Attribute_btn","Other_Option",
                "Frmla_3_Other_Options_search_1",14);
        AddAttributeToRule("Add_Attribute_btn", "Attribute_select",
                "Frmla_3_Attribute_search_3", 15);
        AddOperatorToRule("Add_Attribute_btn", "Operator_select",
                "Frmla_3_Operator_search_3", 16);
        AddValueToRule("Add_Attribute_btn","Value_select",
                "Frmla_3_Value_input_1",17);
        AddOtherOptionToRule("Add_Attribute_btn","Other_Option",
                "Frmla_3_Other_Options_search_2",18);
    ...
    public void RuleAddStep2_3() throws Exception {
        ...
        double j = Double.parseDouble(readdata(19, 1));
        ...
        driver.findElement(By.xpath(getLocator().getProperty("Search_Taxonomy"))).sendKeys(readdata(8, 1));
        Thread.sleep(5000);
        driver.findElement(By.xpath(getLocator().getProperty("Select_all_taxonomy"))).click();
    ...
    public void addProduct() throws Exception {
        ...
        driver.findElement(By.xpath(getLocator().getProperty("SKUvalue"))).sendKeys(readdata(20,1));
        Thread.sleep(2000);
        driver.findElement(By.xpath(getLocator().getProperty("ProductName"))).sendKeys(readdata(21,1));
        Thread.sleep(2000);
        ...
        driver.findElement(By.xpath(getLocator().getProperty("boxtosearch"))).sendKeys(readdata(8,1));
