...
public class Min_Max_SM extends TestBase {
    ...
    public String readdata(int row, int cell) throws Exception {
        return  readExcel("Min_Max_SM",row,cell,Datapath);
    }
    ...
    public void addPossibleValues() throws Exception {
        ...
        driver.findElement(By.xpath(getLocator().getProperty("AddNewValue"))).sendKeys(readdata(7,1));
        ...
        driver.findElement(By.xpath(getLocator().getProperty("AddNewValue"))).sendKeys(readdata(8,1));
        driver.findElement(By.xpath(getLocator().getProperty("AddValuebtn"))).click();
        driver.findElement(By.xpath(getLocator().getProperty("AddNewValue"))).clear();
    ...
    public void addAtributestoTaxonomy() throws Exception {
        ...
        Thread.sleep(2000);
        driver.findElement(By.id(getLocator().getProperty("teonomybox"))).sendKeys(readdata(12,1));
        Thread.sleep(2000);
        ...
        driver.findElement(By.xpath(getLocator().getProperty("SKUvalue"))).sendKeys(readdata(13,1));
        Thread.sleep(2000);
        driver.findElement(By.xpath(getLocator().getProperty("ProductName"))).sendKeys(readdata(14,1));
        Thread.sleep(2000);
        ...
        driver.findElement(By.xpath(getLocator().getProperty("boxtosearch"))).sendKeys(readdata(12,1));
    ...
    public void SelectValuesAndSave() throws Exception {
        ...
        Thread.sleep(5000);
        driver.findElement(By.xpath(getLocator().getProperty("LG_checkbox"))).click();
        driver.findElement(By.xpath(getLocator().getProperty("RedmiCheckbox"))).click();
        driver.findElement(By.xpath(getLocator().getProperty("ClickOutside"))).click();
        driver.findElement(By.xpath(getLocator().getProperty("SelectorClick_2"))).click();
        driver.findElement(By.xpath(getLocator().getProperty("Select_1"))).click();
        driver.findElement(By.xpath(getLocator().getProperty("SelectorClick_2"))).click();
        driver.findElement(By.xpath(getLocator().getProperty("Select_2"))).click();
        driver.findElement(By.xpath(getLocator().getProperty("SelectorClick_2"))).click();
        driver.findElement(By.xpath(getLocator().getProperty("Select_3"))).click();
